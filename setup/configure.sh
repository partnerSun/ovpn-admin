...
OVPN_SRV_DOCKER_BRIDGE_NET=${OVPN_DockerBr_NET:-172.17.0.0}
OVPN_SRV_DOCKER_BrIDGE_MASK=${OVPN_DockerBr_MASK:-255.255.0.0}
...
iptables -t nat -A POSTROUTING -s ${OVPN_SRV_DOCKER_BRIDGE_NET}/${OVPN_SRV_DOCKER_BrIDGE_MASK} ! -d ${OVPN_SRV_DOCKER_BRIDGE_NET}/${OVPN_SRV_DOCKER_BrIDGE_MASK} -j MASQUERADE
